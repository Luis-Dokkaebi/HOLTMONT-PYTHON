...
search8 = """<button class="btn btn-primary text-white fw-bold btn-sm px-3 position-relative ms-4" style="font-size: 0.85rem;" @click="triggerUpload('PLANOS')">
                                        Scope del Trabajo
...
replace8 = """<button class="btn btn-primary text-white fw-bold btn-sm px-4 py-2 position-relative d-flex align-items-center" style="font-size: 0.9rem; background-color: #5b9bd5; border-color: #333;" @click="triggerUpload('PLANOS')">
                                        Scope del Trabajo
...
html_content = html_content.replace(search8, replace8)
