...
| 8.9 | Auditoría espejada con fecha ISO | 1 envío con usuario y accion | envios=1, usuario=LUIS_CARLOS, fecha=2026-08-25T17:38:22.402Z | ✅ PASA |
...
| 9.10 | La cotización se guarda aunque la hoja traiga las tres columnas | success=true y 1 fila | success=true, filas=1, mensaje="Guardado exitoso" | ✅ PASA |
| | _El candado es del Tracker: Ventas queda fuera por ser Ventas_ | | | |
